...
function FeaturedRentalsBlock(props) {
    console.log(props);
    console.log(props.featuredCars.nodes);
    return (
...
export default function FeaturedRentals(props) {
    return <FeaturedRentalsBlock {...props.featuredRentals} />;
}

FeaturedRentals.displayName = 'AcfFeaturedRentals';
